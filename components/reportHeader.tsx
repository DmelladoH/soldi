...
export const ReportHeader = memo<ReportHeaderProps>(
  ({ currentMonth, lastMonth, stocks }) => {
    ...
    return (
      <div className="grid gap-4 auto-rows-auto [grid-template-columns:repeat(auto-fill,minmax(260px,1fr))] [&>div]:col-span-1">
              ...
              lastMonth
                ? {
                    value: formatCurrency(
                      financialCalculations.totalWealth -
                        financialCalculations.previousMonthWealth,
                    ),
                    positive:
                      financialCalculations.totalWealth >
                      financialCalculations.previousMonthWealth,
          ...
          <FinanceCard
            ...
            change={
              lastMonth
                ? {
                    value: formatCurrency(
                      financialCalculations.currentMonthIncome -
                        financialCalculations.lastMonthIncome,
                    ),
                    positive:
                      financialCalculations.currentMonthIncome >
                      financialCalculations.lastMonthIncome,
          ...
          <FinanceCard
            ...
            change={
              lastMonth
                ? {
                    value: formatCurrency(
                      financialCalculations.currentMonthExpenses -
                        financialCalculations.lastMonthExpenses,
                    ),
                    positive:
                      financialCalculations.currentMonthExpenses >
                      financialCalculations.lastMonthExpenses,
