...
const TotalChart = dynamic(() => import("./_components/totalChart").then(mod => ({ default: mod.TotalChart })), {
  loading: () => <Skeleton className="h-[300px] w-full" />,
  ssr: false
})

const FundTable = dynamic(() => import("@/components/fundsTable").then(mod => ({ default: mod.FundTable })), {
  loading: () => <Skeleton className="h-[200px] w-full" />,
  ssr: false
})

const ReportHeader = dynamic(() => import("@/components/reportHeader").then(mod => ({ default: mod.ReportHeader })), {
  loading: () => <Skeleton className="h-[200px] w-full" />,
  ssr: false
})
